...
struct _ENetHost;  // NOLINT(readability-identifier-naming)
struct _ENetEvent; // NOLINT(readability-identifier-naming)
...
private:
	...
	static void AddCompression(_ENetHost* const host);

	Stopwatch m_pingStopwatch;
